...
class ICryptographicAdapter
{
public:
    virtual ~ICryptographicAdapter() = default;

    virtual std::string Encrypt( std::string text, std::string key ) = 0;

    virtual std::string Decrypt( std::string text, std::string key ) = 0;
};

class AesCipher : public ICryptographicAdapter
{
    ...
    // std::vector< std::vector< int > > ShiftRows( std::vector< std::vector< int > > matrix, bool inv = false );
    void ShiftRows( std::vector< std::vector< int > > matrix, bool inv = false );

    void AddRoundKey(std::vector< std::vector< int > > & state, const std::vector< std::vector< int > > & round_keys, int round = 0);

    // std::vector< std::vector< int > >  MixColumns( std::vector< std::vector< int > > state, bool inv = false );
    void MixColumns( std::vector< std::vector< int > > state, bool inv = false );
...
public:
    ...
    virtual std::string Encrypt( std::string text, std::string key ) override;

    virtual std::string Decrypt( std::string text, std::string key ) override;
};
